...
## Tasks
- [ ] **Task 5.1**: Add import execution engine
...
- [ ] **Task 5.2**: Implement rate-limit handling for imports
...
- [ ] **Task 5.3**: Implement row failure behavior
...
- [ ] **Task 5.4**: Add import apply output modes
...
- [ ] **Task 5.5**: Add failed-row export
...
- [ ] **Task 5.6**: Document CSV apply workflows
