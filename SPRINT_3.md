...
## Tasks
- [ ] **Task 3.1**: Add record assert API support
...
- [ ] **Task 3.2**: Implement matching attribute policy
...
- [ ] **Task 3.3**: Add metadata-backed match validation
...
- [ ] **Task 3.4**: Implement `records upsert <object>`
...
- [ ] **Task 3.5**: Improve write error classification
...
- [ ] **Task 3.6**: Document one-off upsert
