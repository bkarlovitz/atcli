...
## Tasks
- [ ] **Task 6.1**: Add list entry API support
...
- [ ] **Task 6.2**: Implement `entries add <list>`
...
- [ ] **Task 6.3**: Implement `entries upsert <list>`
...
- [ ] **Task 6.4**: Add list integration to CSV imports
...
- [ ] **Task 6.5**: Define combined import failure behavior
...
- [ ] **Task 6.6**: Document list entry workflows
